...
import com.reactive.example.ReactiveMongo.ReactiveMongoApplication;
...
public class Main {
	...
	public static void main(String[] args) {
		...
		if (serverName.equals("reactiveMongo") || serverName.equals("react")) {
			ReactiveMongoApplication.main(args);
		} else {
	...
	protected static void usage() {
		...
		System.out.println(
				"     where server-name is 'react' or 'reactiveMongo' and server-port > 7766");
	}
}
